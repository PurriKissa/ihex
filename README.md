...
```
:020000040003F7
:100000000C945C000C946E000C946E000C946E00A6
:00000001FF
```
...
- Accept and ignore whitespace between records (tolerant mode).
- API for feeding entire buffer at once.
- Unit-test suite with known-good / bad files.
- Hook to receive record types/metadata.
